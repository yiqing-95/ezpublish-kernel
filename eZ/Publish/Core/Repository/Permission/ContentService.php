...
class ContentService implements ContentServiceInterface
{
    ...
    {
        $content = $this->innerContentService->loadContent(
            $versionInfo->getContentInfo()->id,
            null,
            $versionInfo->versionNo
        );

        if ( !$this->permissionsService->canUser( 'content', 'edit', $content ) )
            throw new UnauthorizedException( 'content', 'edit' );
    ...
    public function publishVersion( VersionInfo $versionInfo )
    {
        ...
        {
            if ( !$this->permissionsService->canUser( "content", "create", $content ) )
            {
                throw new UnauthorizedException( 'content', 'create' );
            }
        }
        else if ( !$this->permissionsService->canUser( 'content', 'edit', $content ) )
        {
            throw new UnauthorizedException( 'content', 'edit' );
        }
