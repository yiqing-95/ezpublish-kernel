...
if ( !file_exists( __DIR__ . '/config.php' ) && !( $settings = include ( __DIR__ . '/config.php-DEVELOPMENT' ) ) )
{
    throw new \RuntimeException( 'Could not read config.php-DEVELOPMENT, please copy stock config.php-DEVELOPMENT to config.php & customize to your needs!' );
}
else if ( !( $settings = include ( __DIR__ . '/config.php' ) ) )
{
